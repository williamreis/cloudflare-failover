...
#                 db.update_dns(domain['secondary_id'], secondary_ip, secondary_ipv6, secondary_hostname, secondary_type or 'A')
...
#                     db.add_dns(domain_id, "secondary", secondary_ip, secondary_ipv6, secondary_hostname, secondary_type or 'A')
...
#                 cloudflare.update_domain_to_primary(domain['hostname'], 'CNAME', primary_hostname=domain['primary_hostname'])
